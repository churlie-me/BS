            ...
            modelBuilder.Entity("BS.Core.AppointmentService", b =>
                {
                    b.HasOne("BS.Core.Appointment", null)
                        .WithOne("Services")
                        .HasForeignKey("BS.Core.AppointmentService", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
