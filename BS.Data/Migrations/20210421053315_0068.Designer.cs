...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BS.Core.AppointmentService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BS.Core.BranchService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BS.Core.Page", b =>
                {
                    ...
                    b.Property<bool>("ShowLinkInFooter")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BS.Core.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BS.Core.ServiceType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<byte[]>("DarkIcon")
                        .HasColumnType("varbinary(max)");

                    b.Property<bool>("Deleted")
                        .HasColumnType("bit");

                    b.Property<byte[]>("LightIcon")
                        .HasColumnType("varbinary(max)");
            ...
            modelBuilder.Entity("BS.Core.AppointmentService", b =>
                {
                    b.HasOne("BS.Core.Appointment", null)
                        .WithMany("Services")
                    ...
                    b.HasOne("BS.Core.Account", "Stylist")
                        .WithMany()
            ...
            modelBuilder.Entity("BS.Core.Service", b =>
                {
                    ...
                    b.HasOne("BS.Core.ServiceType", null)
                        .WithMany("Services")
